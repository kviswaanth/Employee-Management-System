...
namespace Bookxpert_Project.App_Code {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, string Designation, System.DateTime DateOfJoin, decimal Salary, string Gender, string State) {
...
namespace Bookxpert_Project.App_Code.DataSet1TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([Name], [Designation], [DateOfJoin], [Salary], [Ge" +
                "nder], [State]) VALUES (@Name, @Designation, @DateOfJoin, @Salary, @Gender, @Sta" +
                "te)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE       Employees\r\nSET                Name = @Name, Designation = @Designati" +
                "on, DateOfJoin = @DateOfJoin, Salary = @Salary, Gender = @Gender, State = @State" +
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Designation", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "Designation", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@DateOfJoin", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "DateOfJoin", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Salary", global::System.Data.SqlDbType.Decimal, 9, global::System.Data.ParameterDirection.Input, 10, 2, "Salary", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@State", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "State", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ViswaConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Designation, DateOfJoin, Salary, Gender, State FROM dbo.Employee" +
                "s";
        ...
        public virtual int Insert(string Name, string Designation, global::System.Nullable<global::System.DateTime> DateOfJoin, global::System.Nullable<decimal> Salary, string Gender, string State) {
            if ((Name == null)) {
            ...
            if ((DateOfJoin.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[2].Value = ((System.DateTime)(DateOfJoin.Value));
            }
            else {
        ...
        public virtual int Update(string Name, string Designation, string DateOfJoin, global::System.Nullable<decimal> Salary, string Gender, string State, int Original_Id) {
            if ((Name == null)) {
            ...
            if ((DateOfJoin == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(DateOfJoin));
            }
            if ((Salary.HasValue == true)) {
